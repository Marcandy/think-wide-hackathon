...
export const PRINCIPALS: readonly Principal[] = Object.freeze([PRINCIPAL_A, PRINCIPAL_B])
...
export const GRANT_A: Grant = Object.freeze({
	...
	scopes: Object.freeze(['read:tree', 'read:bytes', 'read:investigation'] as const),
})
...
export const GRANTS: readonly Grant[] = Object.freeze([GRANT_A, GRANT_B, GRANT_A_EXPIRED])
