...
const NO_EFFECTS: ExpectedEffects = Object.freeze({
	writes: 0,
	jobs: 0,
	dispatches: 0,
});
...
export const ACCESS_EXPECTATIONS: readonly AccessExpectation[] = Object.freeze([
	Object.freeze({
		...
		rationale:
			"Current grant, own source and own investigation. Proves the allow path exists at all.",
	}),
	Object.freeze({
		id: "B-reads-B",
		qcase: "Q01",
		...
		expectedEffects: NO_EFFECTS,
		rationale:
			"Independent grant from A. Proves the two principals are genuinely separate.",
	}),
	Object.freeze({
	...
	Object.freeze({
		...
		expectedEffects: NO_EFFECTS,
		rationale:
			"Every referenced object is checked, not only the outer investigation.",
	}),
	Object.freeze({
		...
		expectedEffects: NO_EFFECTS,
		rationale:
			"A self-consistent foreign pair still fails: internal consistency is not authority.",
	}),
	Object.freeze({
		id: "A-expired-grant",
		qcase: "Q01",
		...
		expectedEffects: NO_EFFECTS,
		rationale:
			"Correct principal, correct objects, lapsed grant. Must fail closed on freshness.",
	}),
]);
